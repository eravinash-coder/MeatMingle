                        ...
                        <div className="col-lg-12 col-sm-12 text-center">
                            <div className="main-menu-wrap">
                                ...
                                <nav className="main-menu">
                                    ...
                                    <ul>
                                        <div>
                                            <ul className="top-list mt-2 mt-sm-0 mb-md-0">
                                                <li><a href="https://www.fleshkart.com/account/login"><i className="fa fa-user mr-2"></i>Account</a></li>
                                                <li className="position-relative"><a href=""><i class="fa fa-shopping-cart mr-2"></i>My Cart<span className="badge badge-danger top-noti" id="cart_count_label">0</span></a></li>
                                                <li><a href="#"><i class="fa fa-envelope-o mr-2"></i>sales@demo.com</a></li>
                                                <li>
                                                <div className="form-group srch mb-lg-0">
                                                <input type="text" className="form-control" placeholder="Search Product" aria-label="" aria-describedby="basic-addon2" id="product_search_input"/>
                                                <ul id="searchResult" className="searchResult"></ul>
                                                </div>
                                                </li>
                                            </ul>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-6 col-md-12">
                            <div className="abt-text">
                                ...
                                <a href="#" className="boxed-btn mt-4">know more</a>
                            </div>
                        </div>
                    </div>
                </div>
